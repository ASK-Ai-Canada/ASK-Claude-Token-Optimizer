...
//!
//! Provides common helpers used across ask commands:
...
/// # Examples
/// ```
/// use ask::utils::join_with_overflow;
...
/// # Examples
/// ```
/// use ask::utils::truncate_iso_date;
...
/// # Examples
/// ```no_run
/// use ask::utils::detect_package_manager;
...
mod tests {
    ...
    fn test_detect_package_manager_default() {
        // In the test environment (this repo), there's no JS lockfile
